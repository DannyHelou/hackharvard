...
const LoginForm = ({ setAuthStatus }) => {
  ...
  return (
    <div className="login_form">
      ...
      <form onSubmit={handleSubmit}>
        <div className='text-input-login'>
          <input className='pixel-input'
            type="email"
            placeholder="Email: johnharvard@gmail.com"
            value={email}
        ...
        <div className='text-input-login'>
          <input className='pixel-input'
            type="password"
            placeholder="Password: letmeinplease123"
            value={password}
      ...
      <img src="src\assets\floaty_emblem.png" alt="floaty thing" className='float-image-login'/>
    </div>
  );
};
